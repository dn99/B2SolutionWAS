...
<%
	...
	String teacherYN = request.getParameter("teacherYN");
	String observerYN = request.getParameter("observerYN");
	...
	System.out.println( ":: teacherYN : " + teacherYN );	// Web에서 넘겨받을 필요없음. userState로 처리함.
	System.out.println( ":: observerYN : " + observerYN );	
...
<script src="/resources/flex/b2conference/swfobject.js" type="text/javascript"></script>
<script src="/resources/js/b2conference.js" type="text/javascript"></script>
<style>
html, body 
{
	 height:100%; 
...
<body>
	...
	<script type="text/javascript">
	    ...
	    */
		...
		swfobject.embedSWF("/resources/flex/b2conference/Conf.swf", "flashcontent", "100%", "100%", swfVersionStr, xiSwfUrlStr, flashvars, params);
